...
@ApplicationScoped
public class GeneratePreparationList implements GeneratePreparationListUseCase {

    private final OrderRepository orderRepository;
    private final ProductRepository productRepository;
    private final TimeSlotRepository timeSlotRepository;

    public GeneratePreparationList(OrderRepository orderRepository, ProductRepository productRepository,
    ...
    @Override
    @Transactional
    public List<PreparationOrder> generatePreparationList(Long venteId) {
        ...
        List<TimeSlot> timeSlots = timeSlotRepository.findAllByVenteId(venteId);
