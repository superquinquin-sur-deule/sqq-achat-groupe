...
<template>
  <div data-testid="cart-item" class="flex flex-col gap-2 border-b border-gray-200 py-4 sm:flex-row sm:items-center sm:gap-4">
    <div class="flex-1 min-w-0">
      <p data-testid="item-name" class="text-base font-medium text-dark truncate">{{ item.name }}</p>
