...
import BackofficeNav from './BackofficeNav.vue'
...
<template>
  <header role="banner" class="bg-dark" data-testid="backoffice-header">
    <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-6">
      <h2 class="text-lg font-bold text-white">Back-office</h2>

      <BackofficeNav class="hidden md:block" />

      <div v-if="user" class="flex items-center gap-2" data-testid="backoffice-user-info">
