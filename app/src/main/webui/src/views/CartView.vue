...
<template>
  <main data-testid="cart-view" class="mx-auto max-w-3xl px-4 py-8">
    ...
    <div v-else data-testid="empty-cart" class="mt-12 flex flex-col items-center justify-center text-center">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-12 w-12 text-brown" aria-hidden="true">
