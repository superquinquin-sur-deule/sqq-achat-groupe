...
class GenerateSupplierOrderHandlerTest {
    ...
    void should_aggregate_quantities_by_product_and_sort_by_supplier_then_name() {
        ...
        Product tomatoes = new Product(10L, venteId, "Tomates", "Bio", new BigDecimal("3.50"), "Ferme A", 100, true);
        Product carrots = new Product(20L, venteId, "Carottes", "Bio", new BigDecimal("2.00"), "Ferme A", 100, true);
        Product cheese = new Product(30L, venteId, "Fromage", "Comté", new BigDecimal("8.00"), "Ferme B", 50, true);
