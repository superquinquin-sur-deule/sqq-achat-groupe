...
@ApplicationScoped
public class InitiatePaymentHandler implements CommandHandler<InitiatePaymentCommand, PaymentSession> {
    ...
    public InitiatePaymentHandler(OrderRepository orderRepository, PaymentRepository paymentRepository,
