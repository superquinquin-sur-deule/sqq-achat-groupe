...
const { data: stats, isLoading: loading } = useAdminDashboardQuery(selectedVenteId)
...
<template>
  <div>
    ...
    <div v-if="loading" class="py-12 text-center text-brown">Chargement des statistiques...</div>

    <template v-else-if="stats">
      <div data-testid="dashboard-stats" class="mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard data-testid="stat-total-orders" label="Commandes" :value="stats.totalOrders" />
        <StatCard
